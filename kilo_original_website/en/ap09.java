...
public class ap09 extends PApplet {
...
//  txt16=createFont("Arial", 16); txt13=createFont("Arial", 13); txt10=createFont("Arial", 10);
  ...
  load[0]=new Load('M', 0.25f, 0.75f, -50);
  load[1]=new Load('M', 0.75f, 1.00f, 50);
...
public void eraseAllCalculation() {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "ap09" });
  }
}
