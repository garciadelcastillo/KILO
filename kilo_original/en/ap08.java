...
public class ap08 extends PApplet {
...
int numberOfNodes, numberOfBeams, numberOfLoads, activeLoads=2;
...
//  txt16=createFont("Arial", 16); txt13=createFont("Arial", 13); txt10=createFont("Arial", 10);
  ...
  load[0]=new Load('P', 0.25f, 0.75f, 100);
  load[1]=new Load('P', 0.75f, 1.00f, -100);
...
//  if (cursorModeLoad==true) {load[currentLoad].rf+=sign*0.01; load[currentLoad].ri-=sign*0.01;}
}
public void kbChangeLoadMagnitude(int sign) {
  load[0].magnitude+=sign*1; load[1].magnitude-=sign*1;
}
public void kbChangeLoadRIPosition(int sign) {
  load[0].ri+=sign*0.01f; load[1].ri-=sign*0.01f;
}
...
public void eraseAllCalculation() {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "ap08" });
  }
}
